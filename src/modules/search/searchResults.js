            ...
            <Grid.Row className="search-result-grid-row">
              ...
              <Grid.Column width={12} style={{ marginLeft: "-3%" }}>
                <p className="wordBreak">
                  User Name Lead For Apple Recruting Technology - <b>Apple</b>{" "}
                </p>
                <p className="wordBreak">
                  Worked with over 70+ startups and dozens of leading Silicon
                  Valley VC firms as a Senior UX Designer / Senior Product
                  Designer. Experienced at working with ...
                </p>
              </Grid.Column>
